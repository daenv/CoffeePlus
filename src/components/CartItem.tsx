                    ...
                    {prices.map((data: any, index: any) => (
                        <View key={index.toString()} style={styles.CartItemSizeRowContainer}>
                            ...
                            <View style={styles.CartItemSizeValueContainer}>
                                ...
                                >
                                    <AntDesign name={'minus'} color={COLORS.primaryWhiteHex} size={FONTSIZE.size_12} />
                                </TouchableOpacity>
                                ...
                                >
                                    <AntDesign name={'plus'} color={COLORS.primaryWhiteHex} size={FONTSIZE.size_12} />
                                </TouchableOpacity>
                            </View>
                        </View>
                    ))}
                ...
                >
                    ...
                    <View style={styles.CartItemSingleInfoContainer}>
                        ...
                        <View style={styles.CartItemSingleQuantityContainer}>
                            ...
                            >
                                <AntDesign name="minus" color={COLORS.primaryWhiteHex} size={FONTSIZE.size_10} />
                            </TouchableOpacity>
                            <View style={styles.CartItemQuantityContainer}>
                            ...
                            >
                                <AntDesign name={'plus'} color={COLORS.primaryWhiteHex} size={FONTSIZE.size_10} />
                            </TouchableOpacity>
                        </View>
                    </View>
                </LinearGradient>
